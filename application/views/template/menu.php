 ...
 <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url(). 'eling/home'; ?>"><i class="fa fa-home"></i> Home </a>
                  ...
                  <li><a><i class="fa fa-gear"></i> Setting <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">Akun Pengguna</a></li>
                      <li><a href="tables_dynamic.html">Ganti Password</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Sajian Data <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="chartjs.html">Pendidikan Warga</a></li>
                      <li><a href="chartjs2.html">Usia</a></li>
